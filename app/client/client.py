...
def run():
    ...
    # Extra exercise 1 for lab3: ____________________________________________________________________________
    match3 = stub.CreateMatch(darts_match_pb2.MatchRequest(userName='Abel', matchType='X01')).matchId
    m3_player1 = 0  # owning player always 0
    m3_player2 = stub.RegisterPlayer(darts_match_pb2.RegisterRequest(matchId=match3, userName='Juan')).playerIndex
    # player3 = stub.RegisterPlayer(darts_match_pb2.RegisterRequest(matchId=match1, userName='Eddie')).playerIndex
